...
import org.apache.hadoop.hbase.io.compress.aircompressor.LzoCodec;
...
public class BenchmarkAircompressorLzo {
  ...
  public void setup() throws Exception {
    final String className = LzoCodec.class.getName();
    final Configuration conf = new Configuration();
    conf.set(Compression.LZO_CODEC_CLASS_KEY, className);
